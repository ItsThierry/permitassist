...
HIDDEN_TRIGGER_REGISTRY = [
    ...
    {
        "id": "rtu_replacement_structural_check",
        "severity": "medium",
        ...
        "likely_required_actions": [
            "Verify existing roof structure capacity for new unit weight",
            "Submit stamped structural calcs if unit exceeds original loading",
            "Show curb detail, anchorage, and seismic restraint",
        ],
